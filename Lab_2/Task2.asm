...
Loop
        ;btg  PORTC,RC2          ;Toggle pin, to support measuring loop time (Not needed)
        rcall  PulseTrainGen       
...
Initial
        ...
        MOVLF  B'00000100',PORTA  ;Turn off all four LEDs driven from PORTA ; See pin diagrams of Page 5 in DataSheet
        
		MOVLF  B'11111111',TMR0H ;ADDED by AC
        MOVLF  B'00000000',TMR0L ;ADDED by AC
		MOVLF  B'00001000',ALIVECNT ;ADDED by AC
return
...
; a period of precisely 0.1ms/0.0004ms = 250 clock periods, it needs to remove
...
Bignum  equ     65536-250+12+2 ; x = 0.1ms/0.0004ms

LoopTime                        ; NOT TO BE MODIFIED!!!
...
PulseTrainGen
        ...
        bnz  PTGend
        MOVLF  4,ALIVECNT       ;Reinitialize to C = 4 
        bsf  PORTA,RA2          
PTGend
        return
