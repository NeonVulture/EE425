...
Loop
        ...
        rcall  PulseTrainGen     ;Subroutine   
        rcall  LoopTime         
        bra  Loop
...
; a period of precisely 0.1/0.0004ms = 250 clock periods, it needs to remove
...
Bignum  equ     65536-250+12+2 ; x = 0.1ms/0.0004ms = 250
...
PulseTrainGen
        ...
        bnz  PTGend
        MOVLF  2,ALIVECNT       ;Reinitialize to C = 2 
        bcf  PORTA,RA2          
PTGend
        return
