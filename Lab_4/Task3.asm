...
;;;;;;; Variables ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        ...
        Count_Step               ;Counter for setting rotations
        endc
...
Initial
		...
		MOVLF  B'11111111',TMR0H 
        MOVLF  B'00000000',TMR0L 
return
...
;;;;;; Table 1-4 subroutine ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
; Write your subroutine simulated the oscilloscope output for table 1-4 here.
PulseTrainGen
	MOVLF B'00000001', PORTC ; initialize first sub-sequence
	MOVLF B'00000100', Count_Step
    PT1
        rlncf PORTC, F
        decf Count_Step, F
        bnz PT1
    MOVLF B'00000011', PORTC ; initialize second sub-sequence
